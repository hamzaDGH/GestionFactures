...
import com.example.repository.JustificatifRepository;
...
public class JustificatifController {
	...
	public BodyBuilder uplaodImage(@RequestParam("imageFile") MultipartFile file) throws IOException {
		...
		Justificatif img = new Justificatif(null, file.getOriginalFilename(), file.getContentType(), compressBytes(file.getBytes()));
		justificatifRepository.save(img);
